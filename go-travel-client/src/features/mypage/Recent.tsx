...
const dummyProducts = [
  {
    ...
    region: '파리',
    price: 1500000,
    imageUrl: '/images/package/paris.jpg',
  },
  {
    id: 1,
    name: '도쿄 벚꽃 여행 3일',
  ...
  },
  {
    ...
    region: '뉴욕',
    price: 1200000,
    imageUrl: '/images/package/newyork.jpg',
  },
]
    ...
    <div className="justify-centerpy-10 flex min-h-screen">
      <div className="flex w-full max-w-6xl items-stretch">
        ...
        <main className="flex-1 px-16 py-10">
          {/* 제목 */}
          <h1 className="mb-8 text-3xl font-bold">최근 본 상품</h1>
          <section className="flex flex-1 flex-col gap-5">
            {products.length === 0 ? (
              <div className="p-20 text-center text-gray-500">최근 본 상품이 없습니다.</div>
            ) : (
              products.map((p) => (
                <article
                  key={p.id}
